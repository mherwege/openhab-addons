...
public final class HTTPConstants {
    ...
    public static final String HEADER_ACP_SUBSCRIPTION_KEY = "ocp-apim-subscription-key";
    public static final String HEADER_X_USER_AGENT = "x-user-agent";
    public static final String HEADER_X_IDENTITY_PROVIDER = "x-identity-provider";
    public static final String HEADER_X_CORRELATION_ID = "x-correlation-id";
    public static final String HEADER_BMW_CORRELATION_ID = "bmw-correlation-id";
    public static final String HEADER_BMW_VIN = "bmw-vin";
}
