...
public final class MyBMWConstants {
    ...
    public static final String LAST_FETCHED = "last-fetched";
    ...
    public static final String ESTIMATED_FUEL_L_100KM = "estimated-fuel-l-100km";
    public static final String ESTIMATED_FUEL_MPG = "estimated-fuel-mpg";
