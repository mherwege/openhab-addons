 ...
 */
@NonNullByDefault
public interface NhcMeterEvent {
    ...
    /**
     * Called to indicate the meter has been initialized.
     *
     */
    public void meterInitialized();

    /**
     * Called to indicate the meter has been removed from the Niko Home Control controller.
     *
     */
